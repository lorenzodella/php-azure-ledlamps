...
<head>
    ...
    <script type="text/javascript">
        function requestHTTP(){
            ...
            var url = "set_color_hash.php?color="+encodeURIComponent(document.getElementById('color').value);
            //location.href = url;
    ...
    <body> 
        ...
        <div tyle="text-align: center;">
            <input type="color" id="color" name="color" value="<?php echo isset($_POST["color_now"]) ? $_POST["color_now"] : "#000" ?>">
            <br>
